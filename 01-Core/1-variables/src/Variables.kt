...
fun main() {
    ...
    // Возможно ли изменение значения переменной - val/var
    ...
    val immutableReference: Int = 1   // Инициализация при объявлении
    ...
    var mutableReference = 5 // с повторным использованием
    mutableReference += 1
...
//    myNumber = "Text" //type mismatch error
    ...
    println("After apply: $numberApply") // останется 10, так как `apply` возвращает объект без изменения
