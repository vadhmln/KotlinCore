...
fun main() {
    // List (список) - упорядоченная динамическая коллекция
    // может содержать дубликаты
    val immutableList: List<String> = listOf("Tea", "Coffee", "Tea")
    val valMutableList: MutableList<String> = mutableListOf("Tea", "Coffee", "Tea")
    var varMutableList: MutableList<String> = mutableListOf("Tea", "Coffee", "Tea")
